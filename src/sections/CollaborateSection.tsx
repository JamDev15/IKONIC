...
export default function CollaborateSection() {
  ...
  return (
    <section 
      ref={sectionRef} 
      className="section-pinned bg-charcoal z-30"
    >
      {/* Accent diagonal panel */}
      <div 
        ref={accentPanelRef}
        className="absolute left-[34vw] top-0 w-[18vw] h-full bg-coral z-0"
      ...
      <div 
        ref={topImgRef}
        className="absolute left-[6vw] top-[10vh] w-[42vw] h-[34vh] overflow-hidden z-10"
      >
        <img 
          src="/collab_top.jpg" 
          alt="Collaboration"
      ...
      <div 
        ref={bottomImgRef}
        className="absolute right-[6vw] top-[56vh] w-[42vw] h-[34vh] overflow-hidden z-10"
      >
        <img 
          src="/collab_bottom.jpg" 
      ...
      >
        <p className="text-body text-lg text-offwhite leading-relaxed">
          Workshops, creative sprints, and tight feedback loops—so nothing gets lost in translation.
        </p>
      </div>
      ...
      >
        <h2 className="text-headline text-[10.5vw] text-offwhite">
          COLLABORATE
        </h2>
      </div>
      ...
      >
        <p className="text-body text-lg text-offwhite-dark leading-relaxed">
          From brief to launch, we operate as an extension of your team.
        </p>
      </div>
    </section>
  );
