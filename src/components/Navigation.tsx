    ...
    <>
      ...
      >
        <div className="px-[6vw] flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <Link to="/viral-bot" className="text-sm font-medium text-offwhite-dark hover:text-mint transition-colors">
              Viral Bot
            </Link>
      ...
      >
        <div className="flex flex-col items-center justify-center h-full gap-6 overflow-y-auto py-20">
          ...
          <Link to="/viral-bot" className="text-2xl font-display font-bold text-offwhite hover:text-mint transition-colors">
            Viral Bot
          </Link>
